...
function ConfirmIncrease(e) {
  ...
  if (mount > user.balance) {
    setTimeout(() => {
      ...
      creditUpdate.innerHTML =
        "  المبلغ المراد سحبه أكثر من رصيد العميل..لايمكن اتمام العملية";
    }, 2000);

    setTimeout(() => {
      alert(
        `رصيد العميل الحالي:${user.balance} جنيه المبلغ المراد سحبه:${mount} جنيه`
      );
    ...
    setTimeout(() => {
      ...
      creditUpdate.style.display = "block";
      creditUpdate.innerHTML = "تم خصم المبلغ المحدد من رصيد العميل";
    }, 1500);
